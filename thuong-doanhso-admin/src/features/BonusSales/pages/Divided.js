                        ...
                        {(formikProps) => {
                            ...
                            return (
                                <Form>
                                    <Table bordered responsive>
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="text-center min-w-250px w-40">Hoa hồng</th>
                                                <th className="text-center min-w-250px w-40">Doanh số</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {
                                    ...
                                    <div>
                                        <button className={`btn btn-success ${loading.divided ? "spinner spinner-white spinner-right" : ""}`} type="submit" disabled={loading.divided}>Cập nhập</button>
                                    </div>
                                </Form>
                            )
                        }}
