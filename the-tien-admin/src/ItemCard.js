...
export default function ItemCard({ item, getMoneyCard, index }) {
    ...
    return (
      <React.Fragment>
        <tr>
          <td data-title="STT" className="text-center">
            {index + 1}
          </td>
          ...
          <td data-title="Giá trị">
            ...
            {(item.gioi_han_sp !== 0 || item.gioi_han_dv !== 0) && (
              <div>
                ( Sản phẩm : {formatVND(item.gioi_han_sp)} - Dịch vụ :{" "}
          ...
          <td data-title="Giá trị chi tiêu">
            ...
            {(item.gia_tri_chi_tieu_sp !== 0 ||
              ...
              <div>
                ( Sản phẩm : {formatVND(item.gia_tri_chi_tieu_sp)} - Dịch vụ :{" "}
          ...
          <td data-title="Còn lại">
            ...
            {(item.gia_tri_chi_tieu_sp - item.su_dung_sp !== 0 ||
              ...
              (item.gioi_han_sp !== 0 ||
                ...
                <div>
                  ( Sản phẩm :{" "}
                  {formatVND(item.gia_tri_chi_tieu_sp - item.su_dung_sp)} - Dịch
                  vụ : {formatVND(item.gia_tri_chi_tieu_dv - item.su_dung_dv)})
                </div>
              )}
          </td>
        ...
        {isOpen && (
          <tr>
            <td
              className="moneycard-history title-2"
              colSpan={1}
              data-action="true"
            >
              <div>
            ...
            <td className="moneycard-history" colSpan={5} data-action="content">
